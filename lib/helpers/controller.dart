...
import 'package:frenxy/helpers/types.dart';
...
class Controller {
  ...
  void jumpToPosition(int position) {
    feedback?.add(ControllerFeedback(ControllerCommandTypes.jumpToPosition, data: position));
  }
  ...
  Future<void> animateToPosition(int position) async {
    feedback?.add(ControllerFeedback(ControllerCommandTypes.animateToPosition, data: position));
  }
