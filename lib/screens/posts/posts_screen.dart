...
import 'package:frenxy/widgets/frenxy_camera.dart';
...
class _MakePostScreenState extends State<MakePostScreen> {
  ...
  Future<void> _onImageButtonPressed(ImageSource source) async {
    ...
    if (isVideo) {
      final XFile? file = await _picker.pickVideo(source: source, maxDuration: const Duration(seconds: 30));
  ...
  Widget build(BuildContext context) {
    ...
    //         child: Image(image: AssetImage("assets/images/bb.jpeg")),
    //       ),
    //       Container(
    //         child: Padding(
